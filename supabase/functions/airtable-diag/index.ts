...
Deno.serve(
  withAuditWrapper("airtable-diag", async (req) => {
    ...
    try {
      ...
      console.error("[airtable-diag] schema fetch failed:", e);
      results.schema_error = "fetch failed (see edge function logs)";
    }
    ...
    try {
      ...
      console.error("[airtable-diag] sample fetch failed:", e);
      results.sample_error = "fetch failed (see edge function logs)";
    }
