...
| [0013](0013-consent-ledger-source-of-truth.md)                    | Consent ledger as the single source of truth for marketing consent                 | Accepted |
| [0014](0014-ghost-email-octopus-sync-topology.md)                 | Ghost and Email Octopus sync topology                                              | Accepted |
...
(0008 to 0012 exist in this directory as well). ADRs **0013 to 0016** cover the **email
rearchitecture**; its full skills-vetted requirements live in
`docs/design/email-rearchitecture-requirements.md`, and each ADR here records one load-bearing
decision from it.
